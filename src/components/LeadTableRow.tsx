...
export default function LeadTableRow({ lead, clientId, clientName, onLeadUpdated }: LeadCardProps) {
	...
	const formattedDateTime = lead.created_at
							...
							<ModalBody>
								<div className="grid grid-cols-2 gap-5 -mt-2">
									...
									<div className="flex flex-col">
										...
										<p className="font-sans">{formattedDateTime}</p>
									</div>
									<div className="flex flex-col">
										<p className="text-sm text-gray-700 font-sans">
											Lead Phone
